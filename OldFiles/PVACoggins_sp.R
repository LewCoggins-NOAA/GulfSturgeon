...
plot.surface( obj, type="c", col="red",xlab="M",ylab="CatastrophyFreq")


ProbabilityExtripation100Years=results
Mortality=M[1:numM]
CatastrophyFreq=seq(10,80,by=5)
fig=plot_ly(z=~ProbabilityExtinction100Years,y=~Mortality,x=~CatastrophyFreq)
fig <- fig %>% add_surface()
fig
