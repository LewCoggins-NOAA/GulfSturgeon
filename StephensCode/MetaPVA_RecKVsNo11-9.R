...
#explores No versus RecK with movement simulated among the populations
...
# fig=plot_ly(z=~ProbExtEQ0,y=~InitialNumberFactor,x=~RecruitmentCompensation,type="contour",colors="Greys",contours=contours);fig
# fig=plot_ly(z=~ProbExt1orMore,y=~InitialNumberFactor,x=~RecruitmentCompensation,type="contour",colors="Greys",contours=contours);fig
# fig=plot_ly(z=~ProbExt2orMore,y=~InitialNumberFactor,x=~RecruitmentCompensation,type="contour",colors="Greys",contours=contours);fig
# fig=plot_ly(z=~ProbExt3orMore,y=~InitialNumberFactor,x=~RecruitmentCompensation,type="contour",colors="Greys",contours=contours);fig
# fig=plot_ly(z=~ProbExt4orMore,y=~InitialNumberFactor,x=~RecruitmentCompensation,type="contour",colors="Greys",contours=contours);fig
# fig=plot_ly(z=~ProbExt5orMore,y=~InitialNumberFactor,x=~RecruitmentCompensation,type="contour",colors="Greys",contours=contours);fig
# fig=plot_ly(z=~ProbExt6orMore,y=~InitialNumberFactor,x=~RecruitmentCompensation,type="contour",colors="Greys",contours=contours);fig
# fig=plot_ly(z=~ProbExtEQ7,y=~InitialNumberFactor,x=~RecruitmentCompensation,type="contour",colors="Greys",contours=contours);fig
...
for(j in 1:length(scenarios)){
  ...
  prob_of_losing_100yr_list[[j]][["Matrix"]] <- 
    matrix(sapply(1:(numRecKVals * numNo.FactorVals),function(i)response[[i]]$PropExt.Res[j]),numNo.FactorVals,numRecKVals)
  
  prob_of_losing_100yr_list[[j]][["Plot"]] <- 
        plot_ly(z=~prob_of_losing_100yr_list[[j]][["Matrix"]],y=~InitialNumberFactor,
            x=~RecruitmentCompensation,type="contour",colors="Greys",contours=contours) %>% 
    layout(title=paste0("The Probability that ", scenarios[j], " Extirpated in the next 100 years"),
           xaxis=list(title="Recruitment Compensation"),
           yaxis=list(title="Intial Population Size Factor")) %>% 
...
prob_of_losing_100yr_list[["No Populations"]][["Plot"]] <- 
  plot_ly(z=~prob_of_losing_100yr_list[["No Populations"]][["Matrix"]],y=~InitialNumberFactor,
          x=~RecruitmentCompensation,type="contour",colors="Greys",contours=contours) %>% 
...
for(i in 1:length(scenario_file_title)){
  save_image(prob_of_losing_100yr_list[[i]]$Plot,
             file=paste("C:/Users/lewis.coggins/Documents/GitHub/GulfSturgeon/StephensCode/",scenario_file_title[i],"_prob_extirp_100years.png",sep=""))
}

for(i in 1:length(scenario_file_title)){
  htmlwidgets::saveWidget(prob_of_losing_100yr_list[[i]]$Plot,
                          file=paste("C:/Users/lewis.coggins/Documents/GitHub/GulfSturgeon/StephensCode/",scenario_file_title[i],"_prob_extrip_100years.html",sep=""))
}
...
InitialNumberFactor=rep(No.Factor[1:numNo.FactorVals],numRecKVals)
...
for(i in 1:length(river)){
  ...
  prob_extirp_100yr_list[[i]][["Matrix"]] <- 
    matrix(extir[i,],numNo.FactorVals,numRecKVals)
  
  prob_extirp_100yr_list[[i]][["Plot"]] <- 
    plot_ly(z=~prob_extirp_100yr_list[[i]][["Matrix"]],y=~InitialNumberFactor,
            x=~RecruitmentCompensation,type="contour",colors="Greys",contours=contours) %>% 
...
for(i in 1:length(river)){
  save_image(prob_extirp_100yr_list[[i]]$Plot,
         file=paste("C:/Users/lewis.coggins/Documents/GitHub/GulfSturgeon/StephensCode/",river[i],"_prob_extrip_100years.png",sep=""))
}

for(i in 1:length(river)){
  htmlwidgets::saveWidget(prob_extirp_100yr_list[[i]]$Plot,
                          file=paste("C:/Users/lewis.coggins/Documents/GitHub/GulfSturgeon/StephensCode/",river[i],"_prob_extrip_100years.html",sep=""))
}
...
# save.image("C:/Users/lewis.coggins/Documents/GitHub/GulfSturgeon/StephensCode/MetaPVA_RecKVsNo_workspace.RData")
...
# fig=plot_ly(z=~Pearl_ProbabilityExtripation100Years,y=~InitialNumberFactor,x=~RecruitmentCompensation,type="contour",colors="Greys",contours=contours);fig
# fig=plot_ly(z=~Pascagoula_ProbabilityExtripation100Years,y=~InitialNumberFactor,x=~RecruitmentCompensation,type="contour",colors="Greys",contours=contours);fig
# fig=plot_ly(z=~Escambia_ProbabilityExtripation100Years,y=~InitialNumberFactor,x=~RecruitmentCompensation,type="contour",colors="Greys",contours=contours);fig
# fig=plot_ly(z=~Yellow_ProbabilityExtripation100Years,y=~InitialNumberFactor,x=~RecruitmentCompensation,type="contour",colors="Greys",contours=contours);fig
# fig=plot_ly(z=~Choctawhatchee_ProbabilityExtripation100Years,y=~InitialNumberFactor,x=~RecruitmentCompensation,type="contour",colors="Greys",contours=contours);fig
# fig=plot_ly(z=~Apalachicola_ProbabilityExtripation100Years,y=~InitialNumberFactor,x=~RecruitmentCompensation,type="contour",colors="Greys",contours=contours);fig
# fig=plot_ly(z=~Suwannee_ProbabilityExtripation100Years,y=~InitialNumberFactor,x=~RecruitmentCompensation,type="contour",colors="Greys",contours=contours);fig
