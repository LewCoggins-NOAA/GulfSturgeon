...
#explores Neq_adult versus RecK
...
#              file=paste("C:/Users/Remote/Documents/pva_results/MetaPVA_AdultMvsNeq.adult_Movement_results/all_pops/png/",scenario_file_title[i],"_prob_extirp_100years.png",sep=""))
# }
# 
# for(i in 1:length(scenario_file_title)){
#   htmlwidgets::saveWidget(prob_of_losing_100yr_list[[i]]$Plot,
#                           file=paste("C:/Users/Remote/Documents/pva_results/MetaPVA_AdultMvsNeq.adult_Movement_results/all_pops/html/",scenario_file_title[i],"_prob_extrip_100years.html",sep=""))
# }
# 
# 
# #-----------------------------------------------------------------------------------------------------
...
#              file=paste("C:/Users/Remote/Documents/pva_results/MetaPVA_AdultMvsNeq.adult_Movement_results/individual_pops/png/",river[i],"_prob_extrip_100years.png",sep=""))
# }
# 
# for(i in 1:length(river)){
#   htmlwidgets::saveWidget(prob_extirp_100yr_list[[i]]$Plot,
#                           file=paste("C:/Users/Remote/Documents/pva_results/MetaPVA_AdultMvsNeq.adult_Movement_results/individual_pops/html/",river[i],"_prob_extrip_100years.html",sep=""))
# }
# 

Pearl_ProbabilityExtripation100Years=matrix(extir[1,],numNAduEq.FactorVals,numAM.FactorVals)
Pascagoula_ProbabilityExtripation100Years =matrix(extir[2,],numNAduEq.FactorVals,numAM.FactorVals)
Escambia_ProbabilityExtripation100Years =matrix(extir[3,],numNAduEq.FactorVals,numAM.FactorVals)
Yellow_ProbabilityExtripation100Years =matrix(extir[4,],numNAduEq.FactorVals,numAM.FactorVals)
Choctawhatchee_ProbabilityExtripation100Years =matrix(extir[5,],numNAduEq.FactorVals,numAM.FactorVals)
Apalachicola_ProbabilityExtripation100Years =matrix(extir[6,],numNAduEq.FactorVals,numAM.FactorVals)
Suwannee_ProbabilityExtripation100Years =matrix(extir[7,],numNAduEq.FactorVals,numAM.FactorVals)

contours = list(showlabels = TRUE,start = 0,end = 1,labelfont = list(size = 12, color = "lightgray"))
fig=plot_ly(z=~Pearl_ProbabilityExtripation100Years,y=~EqAduAbun[1,],x=~AdultMortalityFactor,type="contour",colors="Greys",contours=contours);fig
fig=plot_ly(z=~Pascagoula_ProbabilityExtripation100Years,y=~EqAduAbun[2,],x=~AdultMortalityFactor,type="contour",colors="Greys",contours=contours);fig
fig=plot_ly(z=~Escambia_ProbabilityExtripation100Years,y=~EqAduAbun[3,],x=~AdultMortalityFactor,type="contour",colors="Greys",contours=contours);fig
fig=plot_ly(z=~Yellow_ProbabilityExtripation100Years,y=~EqAduAbun[4,],x=~AdultMortalityFactor,type="contour",colors="Greys",contours=contours);fig
fig=plot_ly(z=~Choctawhatchee_ProbabilityExtripation100Years,y=~EqAduAbun[5,],x=~AdultMortalityFactor,type="contour",colors="Greys",contours=contours);fig
fig=plot_ly(z=~Apalachicola_ProbabilityExtripation100Years,y=~EqAduAbun[6,],x=~AdultMortalityFactor,type="contour",colors="Greys",contours=contours);fig
fig=plot_ly(z=~Suwannee_ProbabilityExtripation100Years,y=~EqAduAbun[7,],x=~AdultMortalityFactor,type="contour",colors="Greys",contours=contours);fig

fig=plot_ly(z=~ProbExtEQ0,y=~NAduEq.Factor,x=~AdultMortalityFactor,type="contour",colors="Greys",contours=contours);fig
fig=plot_ly(z=~ProbExt1orMore,y=~NAduEq.Factor,x=~AdultMortalityFactor,type="contour",colors="Greys",contours=contours);fig
fig=plot_ly(z=~ProbExt2orMore,y=~NAduEq.Factor,x=~AdultMortalityFactor,type="contour",colors="Greys",contours=contours);fig
fig=plot_ly(z=~ProbExt3orMore,y=~NAduEq.Factor,x=~AdultMortalityFactor,type="contour",colors="Greys",contours=contours);fig
fig=plot_ly(z=~ProbExt4orMore,y=~NAduEq.Factor,x=~AdultMortalityFactor,type="contour",colors="Greys",contours=contours);fig
fig=plot_ly(z=~ProbExt5orMore,y=~NAduEq.Factor,x=~AdultMortalityFactor,type="contour",colors="Greys",contours=contours);fig
fig=plot_ly(z=~ProbExt6orMore,y=~NAduEq.Factor,x=~AdultMortalityFactor,type="contour",colors="Greys",contours=contours);fig
fig=plot_ly(z=~ProbExtEQ7,y=~NAduEq.Factor,x=~AdultMortalityFactor,type="contour",colors="Greys",contours=contours);fig
