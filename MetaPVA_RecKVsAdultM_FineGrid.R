...
numRecKVals=10
numAM.FactorVals=11
AM.Factor=rep(seq(.5,1.5,length=numAM.FactorVals),numRecKVals);AM.Factor
RecK=rep(seq(2,6.5,length=numRecKVals),each=numAM.FactorVals);RecK
...
AdultMortalityFactor=AM.Factor[1:numAM.FactorVals]
